...
### 1-1. 医院プロフィールを喋らせる
- デモでは、医院名、診療時間、休診日、アクセス、支払い方法、駐車場、当日受付の扱いを固定知識として持たせる
- 典型的な質問に対しては、長く説明せず、事実だけを短く答える
- 例:
  - 「医院名は `VEXUMデンタルクリニック渋谷` です」
  - 「休診日は水曜・日曜・祝日です」
  - 「当日受付は空きがあればご案内できますが、確定はスタッフ確認後です」
  - 「お支払いは現金、主要クレジットカード、交通系ICに対応しています」
  - 「駐車場は専用駐車場がなく、近隣コインパーキングをご案内します」
