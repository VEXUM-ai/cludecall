...
v3 の利用可否と `eleven_v3` / `eleven_v3_conversational` の違いは [docs/agent/v3-availability-research.md](/C:/Dev/Work/デンタル%20一次受付AI/docs/agent/v3-availability-research.md) にまとめてある。
